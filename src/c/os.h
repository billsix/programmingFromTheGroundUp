...
ALWAYS_INLINE static inline long os_open(const char *path, int flags, int mode) {
    long ret;
    __asm__ volatile("int $0x80"
                     : "=a"(ret)
...
ALWAYS_INLINE static inline void os_exit(int status) {
